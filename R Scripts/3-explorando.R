...
all$tamanho <- c("tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam","tam", "tam","tam")  #ainda nao entendi pq so funciona com uma outra coluna tipo essa... mas enfim
...
g2<-ggplot(data=all_2, aes(x=ESFERA5, y=sum,  width=.5)) + # width faz a barra ficar mais fina (ou grossa)
  geom_bar(stat="identity", position=position_dodge(), colour="black")+
  xlab("") +
  ylab("area em km2") +
...
png("figs/figura01.png", res = 300, width = 800, height = 1000)
